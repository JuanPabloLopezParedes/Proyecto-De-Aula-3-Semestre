...
public class Administrador extends javax.swing.JFrame {
    ...
    public Administrador() {
        initComponents();
        setTitle("Ventana De Administracion");
        setLocationRelativeTo(null);
        
        etiHora = new JLabel();
        etiHora.setFont(new Font("Arial", Font.BOLD, 30));
        add(etiHora, BorderLayout.NORTH);
        
        Timer time = new Timer(1000, e -> actualizarHora());
        time.start();
